...
public class ArticleDetailActivity extends ActionBarActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // savedInstanceState is non-null when there is editionFragment state
    // saved from previous configurations of this activity
    // (e.g. when rotating the screen from portrait to landscape).
    // In this case, the editionFragment will automatically be re-added
    ...
    if (savedInstanceState == null) {
      // Create the detail editionFragment and add it to the activity
      // using a editionFragment transaction.
